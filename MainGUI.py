...
class MainGUI:
    def __init__(self):
        ...
        self.startBt = tk.Button(self.optionFrame, text="Inicio", font=("Bold", 20), fg="black", bd=0, bg="#0772D6",
                                 command=self.startFrame)
        ...
        self.showBt = tk.Button(self.optionFrame, text="Mostrar", font=("Bold", 20), fg="black", bd=0, bg="#0772D6",
        ...
        self.insertBt = tk.Button(self.optionFrame, text="Insertar", font=("Bold", 20), fg="black", bd=0, bg="#0772D6",
                                  command=self.insertFrame)
        ...
        self.deleteBt = tk.Button(self.optionFrame, text="Eliminar", font=("Bold", 20), fg="black", bd=0, bg="#0772D6",
                                  command=self.deleteFrame)
        ...
        self.searchBt = tk.Button(self.optionFrame, text="Buscar", font=("Bold", 20), fg="black", bd=0, bg="#0772D6",
                                  command=self.searchFrame)
        ...
        self.infoBt = tk.Button(self.optionFrame, text="¡Conócenos!", font=("Bold", 20), fg="black", bd=0, bg="#0772D6",
                                command=self.infoFrame)
        ...
        self.closeBt = tk.Button(self.optionFrame, text="Cerrar", font=("Bold", 20), fg="black", bd=0, bg="#0772D6",
                                 command=self.close)
    ...
    def deleteFrame(self):
        ...
        eliminar = tk.Button(deleteFrame, text="Eliminar", font=("Times New Roman", 25), borderwidth=20,
                             command=lambda: pb.tree.delete(texteliminar.get(), False) and pb.printRoot(pb.tree.root))
    ...
    def insertFrame(self):
        ...
        insert = tk.Button(insertFrame, text="Insertar", font=("Times New Roman", 25), borderwidth=20,
                           command=lambda: pb.tree.insert(text.get()) and pb.printRoot(pb.tree.root))
        insert = tk.Button(insertFrame, text="Insertar", font=("Times New Roman", 25), borderwidth=20,
                           command=lambda: pb.tree.insert(le.encontrar(text.get())) and pb.printRoot(pb.tree.root))
        insert.pack(pady=10)
    ...
    def searchFrame(self):
        ...
        rdBut2 = tk.Button(searchFrame, text="Buscar en cartelera", font=("Times New Roman", 25), borderwidth=20,
                           command=lambda: le.encontrar(textBox.get()))
        rdBut1.pack(pady=10)
        rdBut2.pack(pady=10)
